...
# fmt: off
# retrieved from https://stackoverflow.com/a/9337047, see also http://mothereff.in/js-variables
# unicode surrogates removed (strings cannot contain them in python)
...
# verbose regex, comments/whitespace ignored
_is_js_func_re = re.compile(
    r"""
...
def is_jsfunc(func: str) -> bool:
    ...
    # stripping str takes almost no time at all
    func = func.strip()
    ...
    return bool(_is_js_func_re.match(func))
