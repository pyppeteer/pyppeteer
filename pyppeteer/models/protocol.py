...
Last regeneration: 2020-04-02 18:52:43.999957
"""
if TYPE_CHECKING:
    ...
    class Protocol:
        ...
        class Events:
            class Animation:
                animationCanceledPayload = animationCanceledPayload
                animationCreatedPayload = animationCreatedPayload
                animationStartedPayload = animationStartedPayload

            class ApplicationCache:
                applicationCacheStatusUpdatedPayload = applicationCacheStatusUpdatedPayload
                networkStateUpdatedPayload = networkStateUpdatedPayload

            class BackgroundService:
                recordingStateChangedPayload = recordingStateChangedPayload
                backgroundServiceEventReceivedPayload = backgroundServiceEventReceivedPayload

            class CSS:
                fontsUpdatedPayload = fontsUpdatedPayload
                mediaQueryResultChangedPayload = None
                styleSheetAddedPayload = styleSheetAddedPayload
                styleSheetChangedPayload = styleSheetChangedPayload
                styleSheetRemovedPayload = styleSheetRemovedPayload

            class Cast:
                sinksUpdatedPayload = sinksUpdatedPayload
                issueUpdatedPayload = issueUpdatedPayload

            class DOM:
                attributeModifiedPayload = attributeModifiedPayload
                attributeRemovedPayload = attributeRemovedPayload
                characterDataModifiedPayload = characterDataModifiedPayload
                childNodeCountUpdatedPayload = childNodeCountUpdatedPayload
                childNodeInsertedPayload = childNodeInsertedPayload
                childNodeRemovedPayload = childNodeRemovedPayload
                distributedNodesUpdatedPayload = distributedNodesUpdatedPayload
                documentUpdatedPayload = None
                inlineStyleInvalidatedPayload = inlineStyleInvalidatedPayload
                pseudoElementAddedPayload = pseudoElementAddedPayload
                pseudoElementRemovedPayload = pseudoElementRemovedPayload
                setChildNodesPayload = setChildNodesPayload
                shadowRootPoppedPayload = shadowRootPoppedPayload
                shadowRootPushedPayload = shadowRootPushedPayload

            class DOMStorage:
                domStorageItemAddedPayload = domStorageItemAddedPayload
                domStorageItemRemovedPayload = domStorageItemRemovedPayload
                domStorageItemUpdatedPayload = domStorageItemUpdatedPayload
                domStorageItemsClearedPayload = domStorageItemsClearedPayload

            class Database:
                addDatabasePayload = addDatabasePayload

            class Emulation:
                virtualTimeBudgetExpiredPayload = None

            class HeadlessExperimental:
                needsBeginFramesChangedPayload = needsBeginFramesChangedPayload
            ...
            class LayerTree:
                layerPaintedPayload = layerPaintedPayload
                layerTreeDidChangePayload = layerTreeDidChangePayload

            class Log:
                entryAddedPayload = entryAddedPayload

            class Network:
                dataReceivedPayload = dataReceivedPayload
                eventSourceMessageReceivedPayload = eventSourceMessageReceivedPayload
                loadingFailedPayload = loadingFailedPayload
                loadingFinishedPayload = loadingFinishedPayload
                requestInterceptedPayload = requestInterceptedPayload
                requestServedFromCachePayload = requestServedFromCachePayload
                requestWillBeSentPayload = requestWillBeSentPayload
                resourceChangedPriorityPayload = resourceChangedPriorityPayload
                signedExchangeReceivedPayload = signedExchangeReceivedPayload
                responseReceivedPayload = responseReceivedPayload
                webSocketClosedPayload = webSocketClosedPayload
                webSocketCreatedPayload = webSocketCreatedPayload
                webSocketFrameErrorPayload = webSocketFrameErrorPayload
                webSocketFrameReceivedPayload = webSocketFrameReceivedPayload
                webSocketFrameSentPayload = webSocketFrameSentPayload
                webSocketHandshakeResponseReceivedPayload = webSocketHandshakeResponseReceivedPayload
                webSocketWillSendHandshakeRequestPayload = webSocketWillSendHandshakeRequestPayload
                requestWillBeSentExtraInfoPayload = requestWillBeSentExtraInfoPayload
                responseReceivedExtraInfoPayload = responseReceivedExtraInfoPayload

            class Overlay:
                inspectNodeRequestedPayload = inspectNodeRequestedPayload
                nodeHighlightRequestedPayload = nodeHighlightRequestedPayload
                screenshotRequestedPayload = screenshotRequestedPayload
                inspectModeCanceledPayload = None

            class Page:
                domContentEventFiredPayload = domContentEventFiredPayload
                fileChooserOpenedPayload = fileChooserOpenedPayload
                frameAttachedPayload = frameAttachedPayload
                frameClearedScheduledNavigationPayload = frameClearedScheduledNavigationPayload
                frameDetachedPayload = frameDetachedPayload
                frameNavigatedPayload = frameNavigatedPayload
                frameResizedPayload = None
                frameRequestedNavigationPayload = frameRequestedNavigationPayload
                frameScheduledNavigationPayload = frameScheduledNavigationPayload
                frameStartedLoadingPayload = frameStartedLoadingPayload
                frameStoppedLoadingPayload = frameStoppedLoadingPayload
                downloadWillBeginPayload = downloadWillBeginPayload
                interstitialHiddenPayload = None
                interstitialShownPayload = None
                javascriptDialogClosedPayload = javascriptDialogClosedPayload
                javascriptDialogOpeningPayload = javascriptDialogOpeningPayload
                lifecycleEventPayload = lifecycleEventPayload
                loadEventFiredPayload = loadEventFiredPayload
                navigatedWithinDocumentPayload = navigatedWithinDocumentPayload
                screencastFramePayload = screencastFramePayload
                screencastVisibilityChangedPayload = screencastVisibilityChangedPayload
                windowOpenPayload = windowOpenPayload
                compilationCacheProducedPayload = compilationCacheProducedPayload

            class Performance:
                metricsPayload = metricsPayload

            class Security:
                certificateErrorPayload = certificateErrorPayload
                visibleSecurityStateChangedPayload = visibleSecurityStateChangedPayload
                securityStateChangedPayload = securityStateChangedPayload

            class ServiceWorker:
                workerErrorReportedPayload = workerErrorReportedPayload
                workerRegistrationUpdatedPayload = workerRegistrationUpdatedPayload
                workerVersionUpdatedPayload = workerVersionUpdatedPayload

            class Storage:
                cacheStorageContentUpdatedPayload = cacheStorageContentUpdatedPayload
                cacheStorageListUpdatedPayload = cacheStorageListUpdatedPayload
                indexedDBContentUpdatedPayload = indexedDBContentUpdatedPayload
                indexedDBListUpdatedPayload = indexedDBListUpdatedPayload

            class Target:
                attachedToTargetPayload = attachedToTargetPayload
                detachedFromTargetPayload = detachedFromTargetPayload
                receivedMessageFromTargetPayload = receivedMessageFromTargetPayload
                targetCreatedPayload = targetCreatedPayload
                targetDestroyedPayload = targetDestroyedPayload
                targetCrashedPayload = targetCrashedPayload
                targetInfoChangedPayload = targetInfoChangedPayload

            class Tethering:
                acceptedPayload = acceptedPayload

            class Tracing:
                bufferUsagePayload = bufferUsagePayload
                dataCollectedPayload = dataCollectedPayload
                tracingCompletePayload = tracingCompletePayload

            class Fetch:
                requestPausedPayload = requestPausedPayload
                authRequiredPayload = authRequiredPayload

            class WebAudio:
                contextCreatedPayload = contextCreatedPayload
                contextWillBeDestroyedPayload = contextWillBeDestroyedPayload
                contextChangedPayload = contextChangedPayload
                audioListenerCreatedPayload = audioListenerCreatedPayload
                audioListenerWillBeDestroyedPayload = audioListenerWillBeDestroyedPayload
                audioNodeCreatedPayload = audioNodeCreatedPayload
                audioNodeWillBeDestroyedPayload = audioNodeWillBeDestroyedPayload
                audioParamCreatedPayload = audioParamCreatedPayload
                audioParamWillBeDestroyedPayload = audioParamWillBeDestroyedPayload
                nodesConnectedPayload = nodesConnectedPayload
                nodesDisconnectedPayload = nodesDisconnectedPayload
                nodeParamConnectedPayload = nodeParamConnectedPayload
                nodeParamDisconnectedPayload = nodeParamDisconnectedPayload

            class Media:
                playerPropertiesChangedPayload = playerPropertiesChangedPayload
                playerEventsAddedPayload = playerEventsAddedPayload
                playersCreatedPayload = playersCreatedPayload

            class Console:
                messageAddedPayload = messageAddedPayload

            class Debugger:
                breakpointResolvedPayload = breakpointResolvedPayload
                pausedPayload = pausedPayload
                resumedPayload = None
                scriptFailedToParsePayload = scriptFailedToParsePayload
                scriptParsedPayload = scriptParsedPayload

            class HeapProfiler:
                addHeapSnapshotChunkPayload = addHeapSnapshotChunkPayload
                heapStatsUpdatePayload = heapStatsUpdatePayload
                lastSeenObjectIdPayload = lastSeenObjectIdPayload
                reportHeapSnapshotProgressPayload = reportHeapSnapshotProgressPayload
                resetProfilesPayload = None

            class Profiler:
                consoleProfileFinishedPayload = consoleProfileFinishedPayload
                consoleProfileStartedPayload = consoleProfileStartedPayload

            class Runtime:
                bindingCalledPayload = bindingCalledPayload
                consoleAPICalledPayload = consoleAPICalledPayload
                exceptionRevokedPayload = exceptionRevokedPayload
                exceptionThrownPayload = exceptionThrownPayload
                executionContextCreatedPayload = executionContextCreatedPayload
                executionContextDestroyedPayload = executionContextDestroyedPayload
                executionContextsClearedPayload = None
                inspectRequestedPayload = inspectRequestedPayload
...
class CommandNames:
    class Accessibility:
        disableReturnValues = 'Accessibility.disableReturnValues'
        enableReturnValues = 'Accessibility.enableReturnValues'
        getPartialAXTreeReturnValues = 'Accessibility.getPartialAXTreeReturnValues'
        getFullAXTreeReturnValues = 'Accessibility.getFullAXTreeReturnValues'

    class Animation:
        disableReturnValues = 'Animation.disableReturnValues'
        enableReturnValues = 'Animation.enableReturnValues'
        getCurrentTimeReturnValues = 'Animation.getCurrentTimeReturnValues'
        getPlaybackRateReturnValues = 'Animation.getPlaybackRateReturnValues'
        releaseAnimationsReturnValues = 'Animation.releaseAnimationsReturnValues'
        resolveAnimationReturnValues = 'Animation.resolveAnimationReturnValues'
        seekAnimationsReturnValues = 'Animation.seekAnimationsReturnValues'
        setPausedReturnValues = 'Animation.setPausedReturnValues'
        setPlaybackRateReturnValues = 'Animation.setPlaybackRateReturnValues'
        setTimingReturnValues = 'Animation.setTimingReturnValues'

    class ApplicationCache:
        enableReturnValues = 'ApplicationCache.enableReturnValues'
        getApplicationCacheForFrameReturnValues = 'ApplicationCache.getApplicationCacheForFrameReturnValues'
        getFramesWithManifestsReturnValues = 'ApplicationCache.getFramesWithManifestsReturnValues'
        getManifestForFrameReturnValues = 'ApplicationCache.getManifestForFrameReturnValues'

    class Audits:
        getEncodedResponseReturnValues = 'Audits.getEncodedResponseReturnValues'

    class BackgroundService:
        startObservingReturnValues = 'BackgroundService.startObservingReturnValues'
        stopObservingReturnValues = 'BackgroundService.stopObservingReturnValues'
        setRecordingReturnValues = 'BackgroundService.setRecordingReturnValues'
        clearEventsReturnValues = 'BackgroundService.clearEventsReturnValues'

    class Browser:
        setPermissionReturnValues = 'Browser.setPermissionReturnValues'
        grantPermissionsReturnValues = 'Browser.grantPermissionsReturnValues'
        resetPermissionsReturnValues = 'Browser.resetPermissionsReturnValues'
        closeReturnValues = 'Browser.closeReturnValues'
        crashReturnValues = 'Browser.crashReturnValues'
        crashGpuProcessReturnValues = 'Browser.crashGpuProcessReturnValues'
        getVersionReturnValues = 'Browser.getVersionReturnValues'
        getBrowserCommandLineReturnValues = 'Browser.getBrowserCommandLineReturnValues'
        getHistogramsReturnValues = 'Browser.getHistogramsReturnValues'
        getHistogramReturnValues = 'Browser.getHistogramReturnValues'
        getWindowBoundsReturnValues = 'Browser.getWindowBoundsReturnValues'
        getWindowForTargetReturnValues = 'Browser.getWindowForTargetReturnValues'
        setWindowBoundsReturnValues = 'Browser.setWindowBoundsReturnValues'
        setDockTileReturnValues = 'Browser.setDockTileReturnValues'

    class CSS:
        addRuleReturnValues = 'CSS.addRuleReturnValues'
        collectClassNamesReturnValues = 'CSS.collectClassNamesReturnValues'
        createStyleSheetReturnValues = 'CSS.createStyleSheetReturnValues'
        disableReturnValues = 'CSS.disableReturnValues'
        enableReturnValues = 'CSS.enableReturnValues'
        forcePseudoStateReturnValues = 'CSS.forcePseudoStateReturnValues'
        getBackgroundColorsReturnValues = 'CSS.getBackgroundColorsReturnValues'
        getComputedStyleForNodeReturnValues = 'CSS.getComputedStyleForNodeReturnValues'
        getInlineStylesForNodeReturnValues = 'CSS.getInlineStylesForNodeReturnValues'
        getMatchedStylesForNodeReturnValues = 'CSS.getMatchedStylesForNodeReturnValues'
        getMediaQueriesReturnValues = 'CSS.getMediaQueriesReturnValues'
        getPlatformFontsForNodeReturnValues = 'CSS.getPlatformFontsForNodeReturnValues'
        getStyleSheetTextReturnValues = 'CSS.getStyleSheetTextReturnValues'
        setEffectivePropertyValueForNodeReturnValues = 'CSS.setEffectivePropertyValueForNodeReturnValues'
        setKeyframeKeyReturnValues = 'CSS.setKeyframeKeyReturnValues'
        setMediaTextReturnValues = 'CSS.setMediaTextReturnValues'
        setRuleSelectorReturnValues = 'CSS.setRuleSelectorReturnValues'
        setStyleSheetTextReturnValues = 'CSS.setStyleSheetTextReturnValues'
        setStyleTextsReturnValues = 'CSS.setStyleTextsReturnValues'
        startRuleUsageTrackingReturnValues = 'CSS.startRuleUsageTrackingReturnValues'
        stopRuleUsageTrackingReturnValues = 'CSS.stopRuleUsageTrackingReturnValues'
        takeCoverageDeltaReturnValues = 'CSS.takeCoverageDeltaReturnValues'

    class CacheStorage:
        deleteCacheReturnValues = 'CacheStorage.deleteCacheReturnValues'
        deleteEntryReturnValues = 'CacheStorage.deleteEntryReturnValues'
        requestCacheNamesReturnValues = 'CacheStorage.requestCacheNamesReturnValues'
        requestCachedResponseReturnValues = 'CacheStorage.requestCachedResponseReturnValues'
        requestEntriesReturnValues = 'CacheStorage.requestEntriesReturnValues'

    class Cast:
        enableReturnValues = 'Cast.enableReturnValues'
        disableReturnValues = 'Cast.disableReturnValues'
        setSinkToUseReturnValues = 'Cast.setSinkToUseReturnValues'
        startTabMirroringReturnValues = 'Cast.startTabMirroringReturnValues'
        stopCastingReturnValues = 'Cast.stopCastingReturnValues'

    class DOM:
        collectClassNamesFromSubtreeReturnValues = 'DOM.collectClassNamesFromSubtreeReturnValues'
        copyToReturnValues = 'DOM.copyToReturnValues'
        describeNodeReturnValues = 'DOM.describeNodeReturnValues'
        disableReturnValues = 'DOM.disableReturnValues'
        discardSearchResultsReturnValues = 'DOM.discardSearchResultsReturnValues'
        enableReturnValues = 'DOM.enableReturnValues'
        focusReturnValues = 'DOM.focusReturnValues'
        getAttributesReturnValues = 'DOM.getAttributesReturnValues'
        getBoxModelReturnValues = 'DOM.getBoxModelReturnValues'
        getContentQuadsReturnValues = 'DOM.getContentQuadsReturnValues'
        getDocumentReturnValues = 'DOM.getDocumentReturnValues'
        getFlattenedDocumentReturnValues = 'DOM.getFlattenedDocumentReturnValues'
        getNodeForLocationReturnValues = 'DOM.getNodeForLocationReturnValues'
        getOuterHTMLReturnValues = 'DOM.getOuterHTMLReturnValues'
        getRelayoutBoundaryReturnValues = 'DOM.getRelayoutBoundaryReturnValues'
        getSearchResultsReturnValues = 'DOM.getSearchResultsReturnValues'
        hideHighlightReturnValues = 'DOM.hideHighlightReturnValues'
        highlightNodeReturnValues = 'DOM.highlightNodeReturnValues'
        highlightRectReturnValues = 'DOM.highlightRectReturnValues'
        markUndoableStateReturnValues = 'DOM.markUndoableStateReturnValues'
        moveToReturnValues = 'DOM.moveToReturnValues'
        performSearchReturnValues = 'DOM.performSearchReturnValues'
        pushNodeByPathToFrontendReturnValues = 'DOM.pushNodeByPathToFrontendReturnValues'
        pushNodesByBackendIdsToFrontendReturnValues = 'DOM.pushNodesByBackendIdsToFrontendReturnValues'
        querySelectorReturnValues = 'DOM.querySelectorReturnValues'
        querySelectorAllReturnValues = 'DOM.querySelectorAllReturnValues'
        redoReturnValues = 'DOM.redoReturnValues'
        removeAttributeReturnValues = 'DOM.removeAttributeReturnValues'
        removeNodeReturnValues = 'DOM.removeNodeReturnValues'
        requestChildNodesReturnValues = 'DOM.requestChildNodesReturnValues'
        requestNodeReturnValues = 'DOM.requestNodeReturnValues'
        resolveNodeReturnValues = 'DOM.resolveNodeReturnValues'
        setAttributeValueReturnValues = 'DOM.setAttributeValueReturnValues'
        setAttributesAsTextReturnValues = 'DOM.setAttributesAsTextReturnValues'
        setFileInputFilesReturnValues = 'DOM.setFileInputFilesReturnValues'
        setNodeStackTracesEnabledReturnValues = 'DOM.setNodeStackTracesEnabledReturnValues'
        getNodeStackTracesReturnValues = 'DOM.getNodeStackTracesReturnValues'
        getFileInfoReturnValues = 'DOM.getFileInfoReturnValues'
        setInspectedNodeReturnValues = 'DOM.setInspectedNodeReturnValues'
        setNodeNameReturnValues = 'DOM.setNodeNameReturnValues'
        setNodeValueReturnValues = 'DOM.setNodeValueReturnValues'
        setOuterHTMLReturnValues = 'DOM.setOuterHTMLReturnValues'
        undoReturnValues = 'DOM.undoReturnValues'
        getFrameOwnerReturnValues = 'DOM.getFrameOwnerReturnValues'

    class DOMDebugger:
        getEventListenersReturnValues = 'DOMDebugger.getEventListenersReturnValues'
        removeDOMBreakpointReturnValues = 'DOMDebugger.removeDOMBreakpointReturnValues'
        removeEventListenerBreakpointReturnValues = 'DOMDebugger.removeEventListenerBreakpointReturnValues'
        removeInstrumentationBreakpointReturnValues = 'DOMDebugger.removeInstrumentationBreakpointReturnValues'
        removeXHRBreakpointReturnValues = 'DOMDebugger.removeXHRBreakpointReturnValues'
        setDOMBreakpointReturnValues = 'DOMDebugger.setDOMBreakpointReturnValues'
        setEventListenerBreakpointReturnValues = 'DOMDebugger.setEventListenerBreakpointReturnValues'
        setInstrumentationBreakpointReturnValues = 'DOMDebugger.setInstrumentationBreakpointReturnValues'
        setXHRBreakpointReturnValues = 'DOMDebugger.setXHRBreakpointReturnValues'

    class DOMSnapshot:
        disableReturnValues = 'DOMSnapshot.disableReturnValues'
        enableReturnValues = 'DOMSnapshot.enableReturnValues'
        getSnapshotReturnValues = 'DOMSnapshot.getSnapshotReturnValues'
        captureSnapshotReturnValues = 'DOMSnapshot.captureSnapshotReturnValues'

    class DOMStorage:
        clearReturnValues = 'DOMStorage.clearReturnValues'
        disableReturnValues = 'DOMStorage.disableReturnValues'
        enableReturnValues = 'DOMStorage.enableReturnValues'
        getDOMStorageItemsReturnValues = 'DOMStorage.getDOMStorageItemsReturnValues'
        removeDOMStorageItemReturnValues = 'DOMStorage.removeDOMStorageItemReturnValues'
        setDOMStorageItemReturnValues = 'DOMStorage.setDOMStorageItemReturnValues'

    class Database:
        disableReturnValues = 'Database.disableReturnValues'
        enableReturnValues = 'Database.enableReturnValues'
        executeSQLReturnValues = 'Database.executeSQLReturnValues'
        getDatabaseTableNamesReturnValues = 'Database.getDatabaseTableNamesReturnValues'

    class DeviceOrientation:
        clearDeviceOrientationOverrideReturnValues = 'DeviceOrientation.clearDeviceOrientationOverrideReturnValues'
        setDeviceOrientationOverrideReturnValues = 'DeviceOrientation.setDeviceOrientationOverrideReturnValues'

    class Emulation:
        canEmulateReturnValues = 'Emulation.canEmulateReturnValues'
        clearDeviceMetricsOverrideReturnValues = 'Emulation.clearDeviceMetricsOverrideReturnValues'
        clearGeolocationOverrideReturnValues = 'Emulation.clearGeolocationOverrideReturnValues'
        resetPageScaleFactorReturnValues = 'Emulation.resetPageScaleFactorReturnValues'
        setFocusEmulationEnabledReturnValues = 'Emulation.setFocusEmulationEnabledReturnValues'
        setCPUThrottlingRateReturnValues = 'Emulation.setCPUThrottlingRateReturnValues'
        setDefaultBackgroundColorOverrideReturnValues = 'Emulation.setDefaultBackgroundColorOverrideReturnValues'
        setDeviceMetricsOverrideReturnValues = 'Emulation.setDeviceMetricsOverrideReturnValues'
        setScrollbarsHiddenReturnValues = 'Emulation.setScrollbarsHiddenReturnValues'
        setDocumentCookieDisabledReturnValues = 'Emulation.setDocumentCookieDisabledReturnValues'
        setEmitTouchEventsForMouseReturnValues = 'Emulation.setEmitTouchEventsForMouseReturnValues'
        setEmulatedMediaReturnValues = 'Emulation.setEmulatedMediaReturnValues'
        setGeolocationOverrideReturnValues = 'Emulation.setGeolocationOverrideReturnValues'
        setNavigatorOverridesReturnValues = 'Emulation.setNavigatorOverridesReturnValues'
        setPageScaleFactorReturnValues = 'Emulation.setPageScaleFactorReturnValues'
        setScriptExecutionDisabledReturnValues = 'Emulation.setScriptExecutionDisabledReturnValues'
        setTouchEmulationEnabledReturnValues = 'Emulation.setTouchEmulationEnabledReturnValues'
        setVirtualTimePolicyReturnValues = 'Emulation.setVirtualTimePolicyReturnValues'
        setTimezoneOverrideReturnValues = 'Emulation.setTimezoneOverrideReturnValues'
        setVisibleSizeReturnValues = 'Emulation.setVisibleSizeReturnValues'
        setUserAgentOverrideReturnValues = 'Emulation.setUserAgentOverrideReturnValues'

    class HeadlessExperimental:
        beginFrameReturnValues = 'HeadlessExperimental.beginFrameReturnValues'
        disableReturnValues = 'HeadlessExperimental.disableReturnValues'
        enableReturnValues = 'HeadlessExperimental.enableReturnValues'

    class IO:
        closeReturnValues = 'IO.closeReturnValues'
        readReturnValues = 'IO.readReturnValues'
        resolveBlobReturnValues = 'IO.resolveBlobReturnValues'

    class IndexedDB:
        clearObjectStoreReturnValues = 'IndexedDB.clearObjectStoreReturnValues'
        deleteDatabaseReturnValues = 'IndexedDB.deleteDatabaseReturnValues'
        deleteObjectStoreEntriesReturnValues = 'IndexedDB.deleteObjectStoreEntriesReturnValues'
        disableReturnValues = 'IndexedDB.disableReturnValues'
        enableReturnValues = 'IndexedDB.enableReturnValues'
        requestDataReturnValues = 'IndexedDB.requestDataReturnValues'
        getMetadataReturnValues = 'IndexedDB.getMetadataReturnValues'
        requestDatabaseReturnValues = 'IndexedDB.requestDatabaseReturnValues'
        requestDatabaseNamesReturnValues = 'IndexedDB.requestDatabaseNamesReturnValues'

    class Input:
        dispatchKeyEventReturnValues = 'Input.dispatchKeyEventReturnValues'
        insertTextReturnValues = 'Input.insertTextReturnValues'
        dispatchMouseEventReturnValues = 'Input.dispatchMouseEventReturnValues'
        dispatchTouchEventReturnValues = 'Input.dispatchTouchEventReturnValues'
        emulateTouchFromMouseEventReturnValues = 'Input.emulateTouchFromMouseEventReturnValues'
        setIgnoreInputEventsReturnValues = 'Input.setIgnoreInputEventsReturnValues'
        synthesizePinchGestureReturnValues = 'Input.synthesizePinchGestureReturnValues'
        synthesizeScrollGestureReturnValues = 'Input.synthesizeScrollGestureReturnValues'
        synthesizeTapGestureReturnValues = 'Input.synthesizeTapGestureReturnValues'

    class Inspector:
        disableReturnValues = 'Inspector.disableReturnValues'
        enableReturnValues = 'Inspector.enableReturnValues'

    class LayerTree:
        compositingReasonsReturnValues = 'LayerTree.compositingReasonsReturnValues'
        disableReturnValues = 'LayerTree.disableReturnValues'
        enableReturnValues = 'LayerTree.enableReturnValues'
        loadSnapshotReturnValues = 'LayerTree.loadSnapshotReturnValues'
        makeSnapshotReturnValues = 'LayerTree.makeSnapshotReturnValues'
        profileSnapshotReturnValues = 'LayerTree.profileSnapshotReturnValues'
        releaseSnapshotReturnValues = 'LayerTree.releaseSnapshotReturnValues'
        replaySnapshotReturnValues = 'LayerTree.replaySnapshotReturnValues'
        snapshotCommandLogReturnValues = 'LayerTree.snapshotCommandLogReturnValues'

    class Log:
        clearReturnValues = 'Log.clearReturnValues'
        disableReturnValues = 'Log.disableReturnValues'
        enableReturnValues = 'Log.enableReturnValues'
        startViolationsReportReturnValues = 'Log.startViolationsReportReturnValues'
        stopViolationsReportReturnValues = 'Log.stopViolationsReportReturnValues'

    class Memory:
        getDOMCountersReturnValues = 'Memory.getDOMCountersReturnValues'
        prepareForLeakDetectionReturnValues = 'Memory.prepareForLeakDetectionReturnValues'
        forciblyPurgeJavaScriptMemoryReturnValues = 'Memory.forciblyPurgeJavaScriptMemoryReturnValues'
        setPressureNotificationsSuppressedReturnValues = 'Memory.setPressureNotificationsSuppressedReturnValues'
        simulatePressureNotificationReturnValues = 'Memory.simulatePressureNotificationReturnValues'
        startSamplingReturnValues = 'Memory.startSamplingReturnValues'
        stopSamplingReturnValues = 'Memory.stopSamplingReturnValues'
        getAllTimeSamplingProfileReturnValues = 'Memory.getAllTimeSamplingProfileReturnValues'
        getBrowserSamplingProfileReturnValues = 'Memory.getBrowserSamplingProfileReturnValues'
        getSamplingProfileReturnValues = 'Memory.getSamplingProfileReturnValues'

    class Network:
        canClearBrowserCacheReturnValues = 'Network.canClearBrowserCacheReturnValues'
        canClearBrowserCookiesReturnValues = 'Network.canClearBrowserCookiesReturnValues'
        canEmulateNetworkConditionsReturnValues = 'Network.canEmulateNetworkConditionsReturnValues'
        clearBrowserCacheReturnValues = 'Network.clearBrowserCacheReturnValues'
        clearBrowserCookiesReturnValues = 'Network.clearBrowserCookiesReturnValues'
        continueInterceptedRequestReturnValues = 'Network.continueInterceptedRequestReturnValues'
        deleteCookiesReturnValues = 'Network.deleteCookiesReturnValues'
        disableReturnValues = 'Network.disableReturnValues'
        emulateNetworkConditionsReturnValues = 'Network.emulateNetworkConditionsReturnValues'
        enableReturnValues = 'Network.enableReturnValues'
        getAllCookiesReturnValues = 'Network.getAllCookiesReturnValues'
        getCertificateReturnValues = 'Network.getCertificateReturnValues'
        getCookiesReturnValues = 'Network.getCookiesReturnValues'
        getResponseBodyReturnValues = 'Network.getResponseBodyReturnValues'
        getRequestPostDataReturnValues = 'Network.getRequestPostDataReturnValues'
        getResponseBodyForInterceptionReturnValues = 'Network.getResponseBodyForInterceptionReturnValues'
        takeResponseBodyForInterceptionAsStreamReturnValues = 'Network.takeResponseBodyForInterceptionAsStreamReturnValues'
        replayXHRReturnValues = 'Network.replayXHRReturnValues'
        searchInResponseBodyReturnValues = 'Network.searchInResponseBodyReturnValues'
        setBlockedURLsReturnValues = 'Network.setBlockedURLsReturnValues'
        setBypassServiceWorkerReturnValues = 'Network.setBypassServiceWorkerReturnValues'
        setCacheDisabledReturnValues = 'Network.setCacheDisabledReturnValues'
        setCookieReturnValues = 'Network.setCookieReturnValues'
        setCookiesReturnValues = 'Network.setCookiesReturnValues'
        setDataSizeLimitsForTestReturnValues = 'Network.setDataSizeLimitsForTestReturnValues'
        setExtraHTTPHeadersReturnValues = 'Network.setExtraHTTPHeadersReturnValues'
        setRequestInterceptionReturnValues = 'Network.setRequestInterceptionReturnValues'
        setUserAgentOverrideReturnValues = 'Network.setUserAgentOverrideReturnValues'

    class Overlay:
        disableReturnValues = 'Overlay.disableReturnValues'
        enableReturnValues = 'Overlay.enableReturnValues'
        getHighlightObjectForTestReturnValues = 'Overlay.getHighlightObjectForTestReturnValues'
        hideHighlightReturnValues = 'Overlay.hideHighlightReturnValues'
        highlightFrameReturnValues = 'Overlay.highlightFrameReturnValues'
        highlightNodeReturnValues = 'Overlay.highlightNodeReturnValues'
        highlightQuadReturnValues = 'Overlay.highlightQuadReturnValues'
        highlightRectReturnValues = 'Overlay.highlightRectReturnValues'
        setInspectModeReturnValues = 'Overlay.setInspectModeReturnValues'
        setShowAdHighlightsReturnValues = 'Overlay.setShowAdHighlightsReturnValues'
        setPausedInDebuggerMessageReturnValues = 'Overlay.setPausedInDebuggerMessageReturnValues'
        setShowDebugBordersReturnValues = 'Overlay.setShowDebugBordersReturnValues'
        setShowFPSCounterReturnValues = 'Overlay.setShowFPSCounterReturnValues'
        setShowPaintRectsReturnValues = 'Overlay.setShowPaintRectsReturnValues'
        setShowLayoutShiftRegionsReturnValues = 'Overlay.setShowLayoutShiftRegionsReturnValues'
        setShowScrollBottleneckRectsReturnValues = 'Overlay.setShowScrollBottleneckRectsReturnValues'
        setShowHitTestBordersReturnValues = 'Overlay.setShowHitTestBordersReturnValues'
        setShowViewportSizeOnResizeReturnValues = 'Overlay.setShowViewportSizeOnResizeReturnValues'

    class Page:
        addScriptToEvaluateOnLoadReturnValues = 'Page.addScriptToEvaluateOnLoadReturnValues'
        addScriptToEvaluateOnNewDocumentReturnValues = 'Page.addScriptToEvaluateOnNewDocumentReturnValues'
        bringToFrontReturnValues = 'Page.bringToFrontReturnValues'
        captureScreenshotReturnValues = 'Page.captureScreenshotReturnValues'
        captureSnapshotReturnValues = 'Page.captureSnapshotReturnValues'
        clearDeviceMetricsOverrideReturnValues = 'Page.clearDeviceMetricsOverrideReturnValues'
        clearDeviceOrientationOverrideReturnValues = 'Page.clearDeviceOrientationOverrideReturnValues'
        clearGeolocationOverrideReturnValues = 'Page.clearGeolocationOverrideReturnValues'
        createIsolatedWorldReturnValues = 'Page.createIsolatedWorldReturnValues'
        deleteCookieReturnValues = 'Page.deleteCookieReturnValues'
        disableReturnValues = 'Page.disableReturnValues'
        enableReturnValues = 'Page.enableReturnValues'
        getAppManifestReturnValues = 'Page.getAppManifestReturnValues'
        getInstallabilityErrorsReturnValues = 'Page.getInstallabilityErrorsReturnValues'
        getCookiesReturnValues = 'Page.getCookiesReturnValues'
        getFrameTreeReturnValues = 'Page.getFrameTreeReturnValues'
        getLayoutMetricsReturnValues = 'Page.getLayoutMetricsReturnValues'
        getNavigationHistoryReturnValues = 'Page.getNavigationHistoryReturnValues'
        resetNavigationHistoryReturnValues = 'Page.resetNavigationHistoryReturnValues'
        getResourceContentReturnValues = 'Page.getResourceContentReturnValues'
        getResourceTreeReturnValues = 'Page.getResourceTreeReturnValues'
        handleJavaScriptDialogReturnValues = 'Page.handleJavaScriptDialogReturnValues'
        navigateReturnValues = 'Page.navigateReturnValues'
        navigateToHistoryEntryReturnValues = 'Page.navigateToHistoryEntryReturnValues'
        printToPDFReturnValues = 'Page.printToPDFReturnValues'
        reloadReturnValues = 'Page.reloadReturnValues'
        removeScriptToEvaluateOnLoadReturnValues = 'Page.removeScriptToEvaluateOnLoadReturnValues'
        removeScriptToEvaluateOnNewDocumentReturnValues = 'Page.removeScriptToEvaluateOnNewDocumentReturnValues'
        screencastFrameAckReturnValues = 'Page.screencastFrameAckReturnValues'
        searchInResourceReturnValues = 'Page.searchInResourceReturnValues'
        setAdBlockingEnabledReturnValues = 'Page.setAdBlockingEnabledReturnValues'
        setBypassCSPReturnValues = 'Page.setBypassCSPReturnValues'
        setDeviceMetricsOverrideReturnValues = 'Page.setDeviceMetricsOverrideReturnValues'
        setDeviceOrientationOverrideReturnValues = 'Page.setDeviceOrientationOverrideReturnValues'
        setFontFamiliesReturnValues = 'Page.setFontFamiliesReturnValues'
        setFontSizesReturnValues = 'Page.setFontSizesReturnValues'
        setDocumentContentReturnValues = 'Page.setDocumentContentReturnValues'
        setDownloadBehaviorReturnValues = 'Page.setDownloadBehaviorReturnValues'
        setGeolocationOverrideReturnValues = 'Page.setGeolocationOverrideReturnValues'
        setLifecycleEventsEnabledReturnValues = 'Page.setLifecycleEventsEnabledReturnValues'
        setTouchEmulationEnabledReturnValues = 'Page.setTouchEmulationEnabledReturnValues'
        startScreencastReturnValues = 'Page.startScreencastReturnValues'
        stopLoadingReturnValues = 'Page.stopLoadingReturnValues'
        crashReturnValues = 'Page.crashReturnValues'
        closeReturnValues = 'Page.closeReturnValues'
        setWebLifecycleStateReturnValues = 'Page.setWebLifecycleStateReturnValues'
        stopScreencastReturnValues = 'Page.stopScreencastReturnValues'
        setProduceCompilationCacheReturnValues = 'Page.setProduceCompilationCacheReturnValues'
        addCompilationCacheReturnValues = 'Page.addCompilationCacheReturnValues'
        clearCompilationCacheReturnValues = 'Page.clearCompilationCacheReturnValues'
        generateTestReportReturnValues = 'Page.generateTestReportReturnValues'
        waitForDebuggerReturnValues = 'Page.waitForDebuggerReturnValues'
        setInterceptFileChooserDialogReturnValues = 'Page.setInterceptFileChooserDialogReturnValues'

    class Performance:
        disableReturnValues = 'Performance.disableReturnValues'
        enableReturnValues = 'Performance.enableReturnValues'
        setTimeDomainReturnValues = 'Performance.setTimeDomainReturnValues'
        getMetricsReturnValues = 'Performance.getMetricsReturnValues'

    class Security:
        disableReturnValues = 'Security.disableReturnValues'
        enableReturnValues = 'Security.enableReturnValues'
        setIgnoreCertificateErrorsReturnValues = 'Security.setIgnoreCertificateErrorsReturnValues'
        handleCertificateErrorReturnValues = 'Security.handleCertificateErrorReturnValues'
        setOverrideCertificateErrorsReturnValues = 'Security.setOverrideCertificateErrorsReturnValues'

    class ServiceWorker:
        deliverPushMessageReturnValues = 'ServiceWorker.deliverPushMessageReturnValues'
        disableReturnValues = 'ServiceWorker.disableReturnValues'
        dispatchSyncEventReturnValues = 'ServiceWorker.dispatchSyncEventReturnValues'
        dispatchPeriodicSyncEventReturnValues = 'ServiceWorker.dispatchPeriodicSyncEventReturnValues'
        enableReturnValues = 'ServiceWorker.enableReturnValues'
        inspectWorkerReturnValues = 'ServiceWorker.inspectWorkerReturnValues'
        setForceUpdateOnPageLoadReturnValues = 'ServiceWorker.setForceUpdateOnPageLoadReturnValues'
        skipWaitingReturnValues = 'ServiceWorker.skipWaitingReturnValues'
        startWorkerReturnValues = 'ServiceWorker.startWorkerReturnValues'
        stopAllWorkersReturnValues = 'ServiceWorker.stopAllWorkersReturnValues'
        stopWorkerReturnValues = 'ServiceWorker.stopWorkerReturnValues'
        unregisterReturnValues = 'ServiceWorker.unregisterReturnValues'
        updateRegistrationReturnValues = 'ServiceWorker.updateRegistrationReturnValues'

    class Storage:
        clearDataForOriginReturnValues = 'Storage.clearDataForOriginReturnValues'
        getCookiesReturnValues = 'Storage.getCookiesReturnValues'
        setCookiesReturnValues = 'Storage.setCookiesReturnValues'
        clearCookiesReturnValues = 'Storage.clearCookiesReturnValues'
        getUsageAndQuotaReturnValues = 'Storage.getUsageAndQuotaReturnValues'
        trackCacheStorageForOriginReturnValues = 'Storage.trackCacheStorageForOriginReturnValues'
        trackIndexedDBForOriginReturnValues = 'Storage.trackIndexedDBForOriginReturnValues'
        untrackCacheStorageForOriginReturnValues = 'Storage.untrackCacheStorageForOriginReturnValues'
        untrackIndexedDBForOriginReturnValues = 'Storage.untrackIndexedDBForOriginReturnValues'

    class SystemInfo:
        getInfoReturnValues = 'SystemInfo.getInfoReturnValues'
        getProcessInfoReturnValues = 'SystemInfo.getProcessInfoReturnValues'

    class Target:
        activateTargetReturnValues = 'Target.activateTargetReturnValues'
        attachToTargetReturnValues = 'Target.attachToTargetReturnValues'
        attachToBrowserTargetReturnValues = 'Target.attachToBrowserTargetReturnValues'
        closeTargetReturnValues = 'Target.closeTargetReturnValues'
        exposeDevToolsProtocolReturnValues = 'Target.exposeDevToolsProtocolReturnValues'
        createBrowserContextReturnValues = 'Target.createBrowserContextReturnValues'
        getBrowserContextsReturnValues = 'Target.getBrowserContextsReturnValues'
        createTargetReturnValues = 'Target.createTargetReturnValues'
        detachFromTargetReturnValues = 'Target.detachFromTargetReturnValues'
        disposeBrowserContextReturnValues = 'Target.disposeBrowserContextReturnValues'
        getTargetInfoReturnValues = 'Target.getTargetInfoReturnValues'
        getTargetsReturnValues = 'Target.getTargetsReturnValues'
        sendMessageToTargetReturnValues = 'Target.sendMessageToTargetReturnValues'
        setAutoAttachReturnValues = 'Target.setAutoAttachReturnValues'
        setDiscoverTargetsReturnValues = 'Target.setDiscoverTargetsReturnValues'
        setRemoteLocationsReturnValues = 'Target.setRemoteLocationsReturnValues'

    class Tethering:
        bindReturnValues = 'Tethering.bindReturnValues'
        unbindReturnValues = 'Tethering.unbindReturnValues'

    class Tracing:
        endReturnValues = 'Tracing.endReturnValues'
        getCategoriesReturnValues = 'Tracing.getCategoriesReturnValues'
        recordClockSyncMarkerReturnValues = 'Tracing.recordClockSyncMarkerReturnValues'
        requestMemoryDumpReturnValues = 'Tracing.requestMemoryDumpReturnValues'
        startReturnValues = 'Tracing.startReturnValues'

    class Fetch:
        disableReturnValues = 'Fetch.disableReturnValues'
        enableReturnValues = 'Fetch.enableReturnValues'
        failRequestReturnValues = 'Fetch.failRequestReturnValues'
        fulfillRequestReturnValues = 'Fetch.fulfillRequestReturnValues'
        continueRequestReturnValues = 'Fetch.continueRequestReturnValues'
        continueWithAuthReturnValues = 'Fetch.continueWithAuthReturnValues'
        getResponseBodyReturnValues = 'Fetch.getResponseBodyReturnValues'
        takeResponseBodyAsStreamReturnValues = 'Fetch.takeResponseBodyAsStreamReturnValues'

    class WebAudio:
        enableReturnValues = 'WebAudio.enableReturnValues'
        disableReturnValues = 'WebAudio.disableReturnValues'
        getRealtimeDataReturnValues = 'WebAudio.getRealtimeDataReturnValues'

    class WebAuthn:
        enableReturnValues = 'WebAuthn.enableReturnValues'
        disableReturnValues = 'WebAuthn.disableReturnValues'
        addVirtualAuthenticatorReturnValues = 'WebAuthn.addVirtualAuthenticatorReturnValues'
        removeVirtualAuthenticatorReturnValues = 'WebAuthn.removeVirtualAuthenticatorReturnValues'
        addCredentialReturnValues = 'WebAuthn.addCredentialReturnValues'
        getCredentialReturnValues = 'WebAuthn.getCredentialReturnValues'
        getCredentialsReturnValues = 'WebAuthn.getCredentialsReturnValues'
        removeCredentialReturnValues = 'WebAuthn.removeCredentialReturnValues'
        clearCredentialsReturnValues = 'WebAuthn.clearCredentialsReturnValues'
        setUserVerifiedReturnValues = 'WebAuthn.setUserVerifiedReturnValues'

    class Media:
        enableReturnValues = 'Media.enableReturnValues'
        disableReturnValues = 'Media.disableReturnValues'

    class Console:
        clearMessagesReturnValues = 'Console.clearMessagesReturnValues'
        disableReturnValues = 'Console.disableReturnValues'
        enableReturnValues = 'Console.enableReturnValues'

    class Debugger:
        continueToLocationReturnValues = 'Debugger.continueToLocationReturnValues'
        disableReturnValues = 'Debugger.disableReturnValues'
        enableReturnValues = 'Debugger.enableReturnValues'
        evaluateOnCallFrameReturnValues = 'Debugger.evaluateOnCallFrameReturnValues'
        getPossibleBreakpointsReturnValues = 'Debugger.getPossibleBreakpointsReturnValues'
        getScriptSourceReturnValues = 'Debugger.getScriptSourceReturnValues'
        getWasmBytecodeReturnValues = 'Debugger.getWasmBytecodeReturnValues'
        getStackTraceReturnValues = 'Debugger.getStackTraceReturnValues'
        pauseReturnValues = 'Debugger.pauseReturnValues'
        pauseOnAsyncCallReturnValues = 'Debugger.pauseOnAsyncCallReturnValues'
        removeBreakpointReturnValues = 'Debugger.removeBreakpointReturnValues'
        restartFrameReturnValues = 'Debugger.restartFrameReturnValues'
        resumeReturnValues = 'Debugger.resumeReturnValues'
        searchInContentReturnValues = 'Debugger.searchInContentReturnValues'
        setAsyncCallStackDepthReturnValues = 'Debugger.setAsyncCallStackDepthReturnValues'
        setBlackboxPatternsReturnValues = 'Debugger.setBlackboxPatternsReturnValues'
        setBlackboxedRangesReturnValues = 'Debugger.setBlackboxedRangesReturnValues'
        setBreakpointReturnValues = 'Debugger.setBreakpointReturnValues'
        setInstrumentationBreakpointReturnValues = 'Debugger.setInstrumentationBreakpointReturnValues'
        setBreakpointByUrlReturnValues = 'Debugger.setBreakpointByUrlReturnValues'
        setBreakpointOnFunctionCallReturnValues = 'Debugger.setBreakpointOnFunctionCallReturnValues'
        setBreakpointsActiveReturnValues = 'Debugger.setBreakpointsActiveReturnValues'
        setPauseOnExceptionsReturnValues = 'Debugger.setPauseOnExceptionsReturnValues'
        setReturnValueReturnValues = 'Debugger.setReturnValueReturnValues'
        setScriptSourceReturnValues = 'Debugger.setScriptSourceReturnValues'
        setSkipAllPausesReturnValues = 'Debugger.setSkipAllPausesReturnValues'
        setVariableValueReturnValues = 'Debugger.setVariableValueReturnValues'
        stepIntoReturnValues = 'Debugger.stepIntoReturnValues'
        stepOutReturnValues = 'Debugger.stepOutReturnValues'
        stepOverReturnValues = 'Debugger.stepOverReturnValues'

    class HeapProfiler:
        addInspectedHeapObjectReturnValues = 'HeapProfiler.addInspectedHeapObjectReturnValues'
        collectGarbageReturnValues = 'HeapProfiler.collectGarbageReturnValues'
        disableReturnValues = 'HeapProfiler.disableReturnValues'
        enableReturnValues = 'HeapProfiler.enableReturnValues'
        getHeapObjectIdReturnValues = 'HeapProfiler.getHeapObjectIdReturnValues'
        getObjectByHeapObjectIdReturnValues = 'HeapProfiler.getObjectByHeapObjectIdReturnValues'
        getSamplingProfileReturnValues = 'HeapProfiler.getSamplingProfileReturnValues'
        startSamplingReturnValues = 'HeapProfiler.startSamplingReturnValues'
        startTrackingHeapObjectsReturnValues = 'HeapProfiler.startTrackingHeapObjectsReturnValues'
        stopSamplingReturnValues = 'HeapProfiler.stopSamplingReturnValues'
        stopTrackingHeapObjectsReturnValues = 'HeapProfiler.stopTrackingHeapObjectsReturnValues'
        takeHeapSnapshotReturnValues = 'HeapProfiler.takeHeapSnapshotReturnValues'

    class Profiler:
        disableReturnValues = 'Profiler.disableReturnValues'
        enableReturnValues = 'Profiler.enableReturnValues'
        getBestEffortCoverageReturnValues = 'Profiler.getBestEffortCoverageReturnValues'
        setSamplingIntervalReturnValues = 'Profiler.setSamplingIntervalReturnValues'
        startReturnValues = 'Profiler.startReturnValues'
        startPreciseCoverageReturnValues = 'Profiler.startPreciseCoverageReturnValues'
        startTypeProfileReturnValues = 'Profiler.startTypeProfileReturnValues'
        stopReturnValues = 'Profiler.stopReturnValues'
        stopPreciseCoverageReturnValues = 'Profiler.stopPreciseCoverageReturnValues'
        stopTypeProfileReturnValues = 'Profiler.stopTypeProfileReturnValues'
        takePreciseCoverageReturnValues = 'Profiler.takePreciseCoverageReturnValues'
        takeTypeProfileReturnValues = 'Profiler.takeTypeProfileReturnValues'
        enableRuntimeCallStatsReturnValues = 'Profiler.enableRuntimeCallStatsReturnValues'
        disableRuntimeCallStatsReturnValues = 'Profiler.disableRuntimeCallStatsReturnValues'
        getRuntimeCallStatsReturnValues = 'Profiler.getRuntimeCallStatsReturnValues'

    class Runtime:
        awaitPromiseReturnValues = 'Runtime.awaitPromiseReturnValues'
        callFunctionOnReturnValues = 'Runtime.callFunctionOnReturnValues'
        compileScriptReturnValues = 'Runtime.compileScriptReturnValues'
        disableReturnValues = 'Runtime.disableReturnValues'
        discardConsoleEntriesReturnValues = 'Runtime.discardConsoleEntriesReturnValues'
        enableReturnValues = 'Runtime.enableReturnValues'
        evaluateReturnValues = 'Runtime.evaluateReturnValues'
        getIsolateIdReturnValues = 'Runtime.getIsolateIdReturnValues'
        getHeapUsageReturnValues = 'Runtime.getHeapUsageReturnValues'
        getPropertiesReturnValues = 'Runtime.getPropertiesReturnValues'
        globalLexicalScopeNamesReturnValues = 'Runtime.globalLexicalScopeNamesReturnValues'
        queryObjectsReturnValues = 'Runtime.queryObjectsReturnValues'
        releaseObjectReturnValues = 'Runtime.releaseObjectReturnValues'
        releaseObjectGroupReturnValues = 'Runtime.releaseObjectGroupReturnValues'
        runIfWaitingForDebuggerReturnValues = 'Runtime.runIfWaitingForDebuggerReturnValues'
        runScriptReturnValues = 'Runtime.runScriptReturnValues'
        setAsyncCallStackDepthReturnValues = 'Runtime.setAsyncCallStackDepthReturnValues'
        setCustomObjectFormatterEnabledReturnValues = 'Runtime.setCustomObjectFormatterEnabledReturnValues'
        setMaxCallStackSizeToCaptureReturnValues = 'Runtime.setMaxCallStackSizeToCaptureReturnValues'
        terminateExecutionReturnValues = 'Runtime.terminateExecutionReturnValues'
        addBindingReturnValues = 'Runtime.addBindingReturnValues'
        removeBindingReturnValues = 'Runtime.removeBindingReturnValues'

    class Schema:
        getDomainsReturnValues = 'Schema.getDomainsReturnValues'
