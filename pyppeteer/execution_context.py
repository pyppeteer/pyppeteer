...
class ExecutionContext(object):
    ...
    def __init__(
        self, client: CDPSession, contextPayload: Dict, objectHandleFactory: Any, frame: 'Frame' = None
    ) -> None:
        self._client = client
        self._frame = frame
    ...
    async def evaluateHandle(self, pageFunction: str, *args: Any, force_expr: bool = False) -> 'JSHandle':  # noqa: C901
        """Execute ``pageFunction`` on this context.
